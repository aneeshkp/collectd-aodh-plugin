...
from collectd_aodh.common.keystone_light import ClientV3
from collectd_aodh.common.keystone_light import KeystoneException
from collectd_aodh.common.settings import Config
import collectd
import json
import logging
import requests
...
ROOT_LOGGER = logging.getLogger(collectd_aodh.__name__)
